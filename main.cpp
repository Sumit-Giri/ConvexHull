...
int main()
{
    ...
    ConvexHull convex;
    string filepath1 = "D://Sumit_Workspace//cpp//Convex 1//Convex//Input//Pointsinput.txt";
    STLReader reader;
    ...
    string filepath = "D://Sumit_Workspace//cpp//Convex 1//Convex//output//convexHUllOutput.txt";
